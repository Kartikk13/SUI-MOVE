module loyalty_card::loyalty_card {
    ...
    const ENotActive: u64 = 1; // Error code when loyalty card is not active
    const EInvalidPoints: u64 = 2; // Error code when points value is invalid
    const EInvalidStatus: u64 = 3; // Error code when loyalty card status is invalid
